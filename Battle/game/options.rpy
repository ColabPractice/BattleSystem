...
init -1 python hide:
    ...
    config.window_title = u"House Guard"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "House Guard"
    config.version = "0.0"
    ...
    # style.window.background = Frame("dialoguebox.png", 50, 50) #TEMP NEED NEW BOX

    ## Margin is space surrounding the window, where the background
    ## is not drawn.

    style.window.left_margin = 225 #was 6
    ...
    style.window.left_padding = 35 #was 6
    ...
    # config.main_menu_music = "primus.ogg"
...
python early:
    config.save_directory = "House Guard-1393192910"
...
init -1 python hide:
    ...
    style.default.color="#835631"
    style.default.drop_shadow = [(1.5, 1)]
    style.default.drop_shadow_color = "#e3ccbc"
    
    style.say_label.color="#835631"
    style.say_label.drop_shadow = [(1.5, 1)]
    style.say_label.drop_shadow_color = "#e3ccbc"
    
    # style.say_who_window.background = Frame("namebox.png", 20, 20) #Background skin NEED NEW ONE
    style.say_who_window.xalign = 0.0
    style.say_who_window.yalign = 1.0
    style.say_who_window.xpos = 15 #For precise placement
...
init python:
    ...
    build.executable_name = "House Guard"
